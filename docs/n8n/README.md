...
>
> Prod prerequisite: apply the latest Supabase migrations via `supabase db push`
> before relying on followup statuses in production.
...
DEMO_FAST_FOLLOWUP=true   # demo only — compressed J1/J3/J7 delays
```
