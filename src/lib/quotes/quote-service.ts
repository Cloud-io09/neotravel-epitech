...
export async function calculateQuoteForLead(
  ...
  return {
    ...
    quote: {
      ...
      vehicle_code: result.quote.vehicle_code,
      distance_km: result.quote.breakdown.distance.distanceKm,
      price_ht: result.quote.price_ht,
      vat_amount: result.quote.vat_amount,
      price_ttc: result.quote.price_ttc,
    },
  };
}
