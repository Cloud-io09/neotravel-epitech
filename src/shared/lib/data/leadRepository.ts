...
const leadSelection =
 "id, status, raw_message, departure_city, arrival_city, departure_date, return_date, passenger_count, trip_type, options, missing_fields, confidence, human_review_reason, ai_summary, created_at, updated_at, clients(organization, email)";
